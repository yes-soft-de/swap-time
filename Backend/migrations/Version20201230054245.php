 ...
 */
final class Version20201230054245 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE swap_entity (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, user_id_one VARCHAR(300) NOT NULL, user_id_two VARCHAR(300) NOT NULL, swap_item_id_one INT NOT NULL, swap_item_id_two INT NOT NULL, cost VARCHAR(12) DEFAULT NULL, room_id VARCHAR(300) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, games_allowed_user_one JSON DEFAULT NULL, games_allowed_user_two JSON DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
