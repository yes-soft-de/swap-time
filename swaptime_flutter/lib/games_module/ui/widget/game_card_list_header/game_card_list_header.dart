            ...
            children: [
              Flex(
                ...
                children: [
                  Container(
                    color:
                        widget.selectedCardType == GameCardType.GAME_CARD_LARGE
                  ...
                  Container(
                    color:
                        widget.selectedCardType == GameCardType.GAME_CARD_MEDIUM
                            ? SwapThemeDataService.getAccent()
                            : SwapThemeDataService.getPrimary(),
                    child: IconButton(
                      icon: Icon(
                  ...
                  Container(
                    color:
                        widget.selectedCardType == GameCardType.GAME_CARD_SMALL
                            ? SwapThemeDataService.getAccent()
                            : SwapThemeDataService.getPrimary(),
                    child: IconButton(
                      icon: Icon(
