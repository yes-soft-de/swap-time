...
import '../../games_module/repository/games_repository/games_repository.dart'
    as _i22;
import '../../module_profile/ui/profile_screen/profile_screen.dart' as _i23;
import '../../module_forms/forms_module.dart' as _i24;
import '../../module_forms/ui/screen/add_by_image/add_by_image.dart' as _i25;
...
class AppComponent$Injector implements _i1.AppComponent {
  ...
  _i10.MyProfileService _createMyProfileService() => _i10.MyProfileService(
      ...
      _createAuthService());
  _i11.MyProfileManager _createMyProfileManager() => _i11.MyProfileManager(
      _createMyProfileRepository(), _createImageUploadService());
  ...
  _i14.ImageUploadService _createImageUploadService() =>
      _i14.ImageUploadService(_createUploadManager());
  _i15.UploadManager _createUploadManager() =>
      _i15.UploadManager(_createUploadRepository());
  _i16.UploadRepository _createUploadRepository() => _i16.UploadRepository();
  ...
  _i22.GamesRepository _createGamesRepository() =>
      _i22.GamesRepository(_createApiClient());
  _i23.ProfileScreen _createProfileScreen() => _i23.ProfileScreen(
      _createGameCardList(), _createAuthService(), _createMyProfileService());
  _i24.FormsModule _createFormsModule() =>
      _i24.FormsModule(_createAddByImageScreen());
  _i25.AddByImageScreen _createAddByImageScreen() =>
      _i25.AddByImageScreen(_createAddByImageStateManager());
  _i26.AddByImageStateManager _createAddByImageStateManager() =>
      _i26.AddByImageStateManager(_createByImageService());
  _i27.ByImageService _createByImageService() =>
      _i27.ByImageService(_createImageUploadService(), _createLogger());
  ...
  _i41.MyProfileScreen _createMyProfileScreen() =>
      _i41.MyProfileScreen(_createMyProfileStateManager());
  _i42.MyProfileStateManager _createMyProfileStateManager() =>
      _i42.MyProfileStateManager(
